...
namespace Server.Services.SavedEGOInfoService
{
    public class SavedEGOInfoService(ISavedInfoRepository<SavedEGOInfo,SavedEgo> saveRepository, RabbitMQUploadingImagePublisher publisher) : ISavedInfoService<SavedEGOInfo>
    {
        ...
        public async Task<SavedEGOInfo> CreateSavedInfo(SavedEGOInfo newSave, SaveInfoFilesRequestDTO files)
        {
        ...
        public async Task<SavedEGOInfo?> UpdateSavedInfo(SavedEGOInfo newSave,SaveInfoFilesRequestDTO files)
        {
            var uploadingImages = await populateImageField(newSave,files);
        ...
        private async Task<List<ImageObj>> populateImageField(SavedEGOInfo savedInfo, SaveInfoFilesRequestDTO files)
        {
            List<Task> tasks = [];
